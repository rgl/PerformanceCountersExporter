...
dist/PerformanceCountersExporter.exe: PerformanceCountersExporter/bin/Release/net461/PerformanceCountersExporter.exe tmp/libz.exe
	mkdir -p dist
	...
	cd PerformanceCountersExporter/bin/Release/net461 && \
	...
	cp PerformanceCountersExporter/bin/Release/net461/PerformanceCountersExporter.exe* dist
...
PerformanceCountersExporter/bin/Release/net461/PerformanceCountersExporter.exe: PerformanceCountersExporter/*
